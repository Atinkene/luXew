...
export default function CreerCategorie() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiWithRetry(() => api.post('/categories', { libelle }));
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Créer une catégorie</h1>
