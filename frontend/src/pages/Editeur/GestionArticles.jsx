...
export default function GestionArticles() {
  ...
  const Notification = ({ message, type, onClose }) => {
    ...
    return (
      <div className={`fixed tinset-x-auto top-0 ${bgColor} text-white px-6 py-2 rounded-lg shadow-lg z-50-lg cursor-pointer`}>
  ...
  return (
    <div className="w mx-auto p-6 bg-gray-100 overflow-y-scroll ">
      {notification && (
